    ...
    extend: {
      ...
      backgroundImage: {
        'content-wrapper-header':
          "url('/assets/img/cubes.png'), linear-gradient(to right top, #cf4af3, #e73bd7, #f631bc, #fd31a2, #ff3a8b, #ff4b78, #ff5e68, #ff705c, #ff8c51, #ffaa49, #ffc848, #ffe652)",
        'video-bg': "linear-gradient(180deg, rgba(255, 255, 255, 0.72) 0%, rgba(255, 255, 255, 0.45) 100%)",
      },
      colors: {
