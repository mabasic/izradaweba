...
function $s_Leu_izradaweba_js_Main__main__AT__V(args) {
  try {
    $m_Leu_izradaweba_js_Main$package$().Main__V()
  } catch (e) {
    if (false) {
...
function $p_Leu_izradaweba_js_Main$package$__Theme$lzyINIT1$1__Lorg_scalajs_dom_MediaQueryList__sr_LazyRef__Leu_izradaweba_js_Main$package$Theme$2$($thiz, prefersDark0$1, Theme$lzy1$1) {
  if ((Theme$lzy1$1 === null)) {
    throw new $c_jl_NullPointerException()
  };
  return $as_Leu_izradaweba_js_Main$package$Theme$2$((Theme$lzy1$1.sr_LazyRef__f__initialized ? Theme$lzy1$1.sr_LazyRef__f__value : Theme$lzy1$1.initialize__O__O(new $c_Leu_izradaweba_js_Main$package$Theme$2$(prefersDark0$1))))
}
function $p_Leu_izradaweba_js_Main$package$__Theme$1__Lorg_scalajs_dom_MediaQueryList__sr_LazyRef__Leu_izradaweba_js_Main$package$Theme$2$($thiz, prefersDark0$2, Theme$lzy1$2) {
  return $as_Leu_izradaweba_js_Main$package$Theme$2$((Theme$lzy1$2.sr_LazyRef__f__initialized ? Theme$lzy1$2.sr_LazyRef__f__value : $p_Leu_izradaweba_js_Main$package$__Theme$lzyINIT1$1__Lorg_scalajs_dom_MediaQueryList__sr_LazyRef__Leu_izradaweba_js_Main$package$Theme$2$($thiz, prefersDark0$2, Theme$lzy1$2)))
}
/** @constructor */
function $c_Leu_izradaweba_js_Main$package$() {
  this.Leu_izradaweba_js_Main$package$__f_darkClass = null;
  this.Leu_izradaweba_js_Main$package$__f_lightClass = null;
  this.Leu_izradaweba_js_Main$package$__f_hiddenClass = null;
  this.Leu_izradaweba_js_Main$package$__f_darkClass = "dark";
  this.Leu_izradaweba_js_Main$package$__f_lightClass = "light";
  this.Leu_izradaweba_js_Main$package$__f_hiddenClass = "hidden"
}
$c_Leu_izradaweba_js_Main$package$.prototype = new $h_O();
$c_Leu_izradaweba_js_Main$package$.prototype.constructor = $c_Leu_izradaweba_js_Main$package$;
/** @constructor */
function $h_Leu_izradaweba_js_Main$package$() {
  /*<skip>*/
}
$h_Leu_izradaweba_js_Main$package$.prototype = $c_Leu_izradaweba_js_Main$package$.prototype;
$c_Leu_izradaweba_js_Main$package$.prototype.getLocalStorageTheme__T = (function() {
  return $as_T(window.localStorage.getItem("theme"))
});
$c_Leu_izradaweba_js_Main$package$.prototype.addDarkClassToBody__V = (function() {
  document.documentElement.classList.add($m_Leu_izradaweba_js_Main$package$().Leu_izradaweba_js_Main$package$__f_darkClass)
});
$c_Leu_izradaweba_js_Main$package$.prototype.removeDarkClassFromBody__V = (function() {
  document.documentElement.classList.remove($m_Leu_izradaweba_js_Main$package$().Leu_izradaweba_js_Main$package$__f_darkClass)
});
$c_Leu_izradaweba_js_Main$package$.prototype.setLightTheme__Leu_izradaweba_js_ThemeInterface__V = (function(theme) {
  $m_Leu_izradaweba_js_Main$package$().removeDarkClassFromBody__V();
  theme.Leu_izradaweba_js_Main$package$Theme$2$__f_automaticSvg.classList.add($m_Leu_izradaweba_js_Main$package$().Leu_izradaweba_js_Main$package$__f_hiddenClass);
  theme.Leu_izradaweba_js_Main$package$Theme$2$__f_darkSvg.classList.add($m_Leu_izradaweba_js_Main$package$().Leu_izradaweba_js_Main$package$__f_hiddenClass);
  theme.Leu_izradaweba_js_Main$package$Theme$2$__f_lightSvg.classList.remove($m_Leu_izradaweba_js_Main$package$().Leu_izradaweba_js_Main$package$__f_hiddenClass)
});
$c_Leu_izradaweba_js_Main$package$.prototype.setDarkTheme__Leu_izradaweba_js_ThemeInterface__V = (function(theme) {
  $m_Leu_izradaweba_js_Main$package$().addDarkClassToBody__V();
  theme.Leu_izradaweba_js_Main$package$Theme$2$__f_automaticSvg.classList.add($m_Leu_izradaweba_js_Main$package$().Leu_izradaweba_js_Main$package$__f_hiddenClass);
  theme.Leu_izradaweba_js_Main$package$Theme$2$__f_darkSvg.classList.remove($m_Leu_izradaweba_js_Main$package$().Leu_izradaweba_js_Main$package$__f_hiddenClass);
  theme.Leu_izradaweba_js_Main$package$Theme$2$__f_lightSvg.classList.add($m_Leu_izradaweba_js_Main$package$().Leu_izradaweba_js_Main$package$__f_hiddenClass)
});
$c_Leu_izradaweba_js_Main$package$.prototype.setAutomaticTheme__Leu_izradaweba_js_ThemeInterface__Z__V = (function(theme, darkTheme) {
  theme.Leu_izradaweba_js_Main$package$Theme$2$__f_automaticSvg.classList.remove($m_Leu_izradaweba_js_Main$package$().Leu_izradaweba_js_Main$package$__f_hiddenClass);
  theme.Leu_izradaweba_js_Main$package$Theme$2$__f_darkSvg.classList.add($m_Leu_izradaweba_js_Main$package$().Leu_izradaweba_js_Main$package$__f_hiddenClass);
  theme.Leu_izradaweba_js_Main$package$Theme$2$__f_lightSvg.classList.add($m_Leu_izradaweba_js_Main$package$().Leu_izradaweba_js_Main$package$__f_hiddenClass);
  if (darkTheme) {
    $m_Leu_izradaweba_js_Main$package$().addDarkClassToBody__V()
...
$c_Leu_izradaweba_js_Main$package$.prototype.setupMobileNavbarToggle__V = (function() {
  var mobileNavbar = document.getElementById("mobile-navbar");
  var mobileNavbarToggle = document.getElementById("mobile-navbar-toggle");
  mobileNavbarToggle.addEventListener("click", ((_$1) => $uZ(mobileNavbar.classList.toggle($m_Leu_izradaweba_js_Main$package$().Leu_izradaweba_js_Main$package$__f_hiddenClass))))
});
$c_Leu_izradaweba_js_Main$package$.prototype.setupModal__V = (function() {
  var closedPopup = document.getElementById("pop-up");
  var overlayApp = document.getElementById("overlay-app");
  var popupCloseTriggers = closedPopup.getElementsByClassName("close-pop-up");
  var this$2 = new $c_Lorg_scalajs_dom_DOMList$DOMListSeq(popupCloseTriggers);
  var it = this$2.iterator__sc_Iterator();
  while (it.hasNext__Z()) {
    var arg1 = it.next__O();
    arg1.addEventListener("click", ((closedPopup, overlayApp) => ((_$2) => {
    ...
    }))(closedPopup, overlayApp))
  };
  var popupOpenTriggers = document.getElementsByClassName("open-pop-up");
  var this$5 = new $c_Lorg_scalajs_dom_DOMList$DOMListSeq(popupOpenTriggers);
  var it$1 = this$5.iterator__sc_Iterator();
  while (it$1.hasNext__Z()) {
    var arg1$1 = it$1.next__O();
    arg1$1.addEventListener("click", ((closedPopup, overlayApp) => ((_$3) => {
...
$c_Leu_izradaweba_js_Main$package$.prototype.enableThemeSwitching__Leu_izradaweba_js_ThemeInterface__V = (function(theme) {
  var themeSwitchButton = document.getElementById("theme-switch");
  themeSwitchButton.addEventListener("click", ((_$4) => {
    var localStorageTheme = $m_Leu_izradaweba_js_Main$package$().getLocalStorageTheme__T();
    return ((localStorageTheme === null) ? ($m_Leu_izradaweba_js_Main$package$().setDarkTheme__Leu_izradaweba_js_ThemeInterface__V(theme), window.localStorage.setItem("theme", $m_Leu_izradaweba_js_Main$package$().Leu_izradaweba_js_Main$package$__f_darkClass), (void 0)) : ((localStorageTheme === $m_Leu_izradaweba_js_Main$package$().Leu_izradaweba_js_Main$package$__f_darkClass) ? ($m_Leu_izradaweba_js_Main$package$().setLightTheme__Leu_izradaweba_js_ThemeInterface__V(theme), window.localStorage.setItem("theme", $m_Leu_izradaweba_js_Main$package$().Leu_izradaweba_js_Main$package$__f_lightClass), (void 0)) : ((localStorageTheme === $m_Leu_izradaweba_js_Main$package$().Leu_izradaweba_js_Main$package$__f_lightClass) ? (($uZ(theme.Leu_izradaweba_js_Main$package$Theme$2$__f_prefersDark.matches) ? $m_Leu_izradaweba_js_Main$package$().setAutomaticTheme__Leu_izradaweba_js_ThemeInterface__Z__V(theme, true) : $m_Leu_izradaweba_js_Main$package$().setAutomaticTheme__Leu_izradaweba_js_ThemeInterface__Z__V(theme, false)), window.localStorage.removeItem("theme"), (void 0)) : (void 0))))
  }))
});
$c_Leu_izradaweba_js_Main$package$.prototype.applyTheme__Leu_izradaweba_js_ThemeInterface__V = (function(theme) {
  var localStorageTheme = $m_Leu_izradaweba_js_Main$package$().getLocalStorageTheme__T();
  var x = theme.Leu_izradaweba_js_Main$package$Theme$2$__f_prefersDark;
  var this$2 = $m_s_Console$();
  var this$3 = this$2.out__Ljava_io_PrintStream();
  this$3.java$lang$JSConsoleBasedPrintStream$$printString__T__V((x + "\n"));
  if ((localStorageTheme === $m_Leu_izradaweba_js_Main$package$().Leu_izradaweba_js_Main$package$__f_lightClass)) {
    $m_Leu_izradaweba_js_Main$package$().setLightTheme__Leu_izradaweba_js_ThemeInterface__V(theme)
  } else if ((localStorageTheme === $m_Leu_izradaweba_js_Main$package$().Leu_izradaweba_js_Main$package$__f_darkClass)) {
    $m_Leu_izradaweba_js_Main$package$().setDarkTheme__Leu_izradaweba_js_ThemeInterface__V(theme)
  } else if ($uZ(theme.Leu_izradaweba_js_Main$package$Theme$2$__f_prefersDark.matches)) {
    $m_Leu_izradaweba_js_Main$package$().setAutomaticTheme__Leu_izradaweba_js_ThemeInterface__Z__V(theme, true)
  } else {
    $m_Leu_izradaweba_js_Main$package$().setAutomaticTheme__Leu_izradaweba_js_ThemeInterface__Z__V(theme, false)
  }
});
$c_Leu_izradaweba_js_Main$package$.prototype.detectThemeChange__Leu_izradaweba_js_ThemeInterface__V = (function(theme) {
  var x = theme.Leu_izradaweba_js_Main$package$Theme$2$__f_prefersDark;
  var this$2 = $m_s_Console$();
  var this$3 = this$2.out__Ljava_io_PrintStream();
  this$3.java$lang$JSConsoleBasedPrintStream$$printString__T__V((x + "\n"));
  var \u03b41$ = theme.Leu_izradaweba_js_Main$package$Theme$2$__f_prefersDark;
  \u03b41$.addEventListener("change", ((e) => {
    var localStorageTheme = $m_Leu_izradaweba_js_Main$package$().getLocalStorageTheme__T();
...
$c_Leu_izradaweba_js_Main$package$.prototype.setupThemeSwitcher__Lorg_scalajs_dom_MediaQueryList__V = (function(prefersDark0) {
  var Theme$lzy1 = new $c_sr_LazyRef();
  $m_Leu_izradaweba_js_Main$package$().applyTheme__Leu_izradaweba_js_ThemeInterface__V($p_Leu_izradaweba_js_Main$package$__Theme$1__Lorg_scalajs_dom_MediaQueryList__sr_LazyRef__Leu_izradaweba_js_Main$package$Theme$2$(this, prefersDark0, Theme$lzy1));
  $m_Leu_izradaweba_js_Main$package$().detectThemeChange__Leu_izradaweba_js_ThemeInterface__V($p_Leu_izradaweba_js_Main$package$__Theme$1__Lorg_scalajs_dom_MediaQueryList__sr_LazyRef__Leu_izradaweba_js_Main$package$Theme$2$(this, prefersDark0, Theme$lzy1));
  $m_Leu_izradaweba_js_Main$package$().enableThemeSwitching__Leu_izradaweba_js_ThemeInterface__V($p_Leu_izradaweba_js_Main$package$__Theme$1__Lorg_scalajs_dom_MediaQueryList__sr_LazyRef__Leu_izradaweba_js_Main$package$Theme$2$(this, prefersDark0, Theme$lzy1))
});
$c_Leu_izradaweba_js_Main$package$.prototype.Main__V = (function() {
  var localStorageTheme = $m_Leu_izradaweba_js_Main$package$().getLocalStorageTheme__T();
  var prefersDark = window.matchMedia("(prefers-color-scheme: dark)");
  var this$2 = $m_s_Console$();
  var this$3 = this$2.out__Ljava_io_PrintStream();
  this$3.java$lang$JSConsoleBasedPrintStream$$printString__T__V((prefersDark + "\n"));
  if ((localStorageTheme === $m_Leu_izradaweba_js_Main$package$().Leu_izradaweba_js_Main$package$__f_lightClass)) {
    $m_Leu_izradaweba_js_Main$package$().removeDarkClassFromBody__V()
  } else if ((localStorageTheme === $m_Leu_izradaweba_js_Main$package$().Leu_izradaweba_js_Main$package$__f_darkClass)) {
    $m_Leu_izradaweba_js_Main$package$().addDarkClassToBody__V()
  } else if ($uZ(prefersDark.matches)) {
    $m_Leu_izradaweba_js_Main$package$().addDarkClassToBody__V()
  } else {
    $m_Leu_izradaweba_js_Main$package$().removeDarkClassFromBody__V()
  };
  document.addEventListener("DOMContentLoaded", ((_$5) => {
    $m_Leu_izradaweba_js_Main$package$().setupMobileNavbarToggle__V();
    $m_Leu_izradaweba_js_Main$package$().setupModal__V();
    $m_Leu_izradaweba_js_Main$package$().setupThemeSwitcher__Lorg_scalajs_dom_MediaQueryList__V(prefersDark)
  }))
});
var $d_Leu_izradaweba_js_Main$package$ = new $TypeData().initClass({
  Leu_izradaweba_js_Main$package$: 0
}, false, "eu.izradaweba.js.Main$package$", {
  Leu_izradaweba_js_Main$package$: 1,
  O: 1
});
$c_Leu_izradaweba_js_Main$package$.prototype.$classData = $d_Leu_izradaweba_js_Main$package$;
var $n_Leu_izradaweba_js_Main$package$;
function $m_Leu_izradaweba_js_Main$package$() {
  if ((!$n_Leu_izradaweba_js_Main$package$)) {
    $n_Leu_izradaweba_js_Main$package$ = new $c_Leu_izradaweba_js_Main$package$()
  };
  return $n_Leu_izradaweba_js_Main$package$
}
/** @constructor */
...
/** @constructor */
function $c_Leu_izradaweba_js_Main$package$Theme$2$(prefersDark0$3) {
  this.Leu_izradaweba_js_Main$package$Theme$2$__f_automaticSvg = null;
  this.Leu_izradaweba_js_Main$package$Theme$2$__f_darkSvg = null;
  this.Leu_izradaweba_js_Main$package$Theme$2$__f_lightSvg = null;
  this.Leu_izradaweba_js_Main$package$Theme$2$__f_prefersDark = null;
  this.Leu_izradaweba_js_Main$package$Theme$2$__f_automaticSvg = document.getElementById("theme-automatic");
  this.Leu_izradaweba_js_Main$package$Theme$2$__f_darkSvg = document.getElementById("theme-dark");
  this.Leu_izradaweba_js_Main$package$Theme$2$__f_lightSvg = document.getElementById("theme-light");
  this.Leu_izradaweba_js_Main$package$Theme$2$__f_prefersDark = prefersDark0$3
}
$c_Leu_izradaweba_js_Main$package$Theme$2$.prototype = new $h_O();
$c_Leu_izradaweba_js_Main$package$Theme$2$.prototype.constructor = $c_Leu_izradaweba_js_Main$package$Theme$2$;
/** @constructor */
function $h_Leu_izradaweba_js_Main$package$Theme$2$() {
  /*<skip>*/
}
$h_Leu_izradaweba_js_Main$package$Theme$2$.prototype = $c_Leu_izradaweba_js_Main$package$Theme$2$.prototype;
function $as_Leu_izradaweba_js_Main$package$Theme$2$(obj) {
  return (((obj instanceof $c_Leu_izradaweba_js_Main$package$Theme$2$) || (obj === null)) ? obj : $throwClassCastException(obj, "eu.izradaweba.js.Main$package$Theme$2$"))
}
function $isArrayOf_Leu_izradaweba_js_Main$package$Theme$2$(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Leu_izradaweba_js_Main$package$Theme$2$)))
}
function $asArrayOf_Leu_izradaweba_js_Main$package$Theme$2$(obj, depth) {
  return (($isArrayOf_Leu_izradaweba_js_Main$package$Theme$2$(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Leu.izradaweba.js.Main$package$Theme$2$;", depth))
}
var $d_Leu_izradaweba_js_Main$package$Theme$2$ = new $TypeData().initClass({
  Leu_izradaweba_js_Main$package$Theme$2$: 0
}, false, "eu.izradaweba.js.Main$package$Theme$2$", {
  Leu_izradaweba_js_Main$package$Theme$2$: 1,
  O: 1,
  Leu_izradaweba_js_ThemeInterface: 1
});
$c_Leu_izradaweba_js_Main$package$Theme$2$.prototype.$classData = $d_Leu_izradaweba_js_Main$package$Theme$2$;
...
$L0 = new $c_RTLong(0, 0);
$d_J.zero = $L0;
$s_Leu_izradaweba_js_Main__main__AT__V(new ($d_T.getArrayOf().constr)([]));
}).call(this);
